...
public class Activity_yaowen extends AppCompatActivity {
    //底部栏的跳转
    ...
    private void initView() {
        ...
        ln_yonghu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Activity_yaowen.this, Activity_user.class);
        ...
        ln_zhuye.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Activity_yaowen.this, MainActivity.class);
                startActivity(intent);
            }
        });
