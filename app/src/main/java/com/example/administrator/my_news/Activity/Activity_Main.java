...
public class Activity_Main extends AppCompatActivity {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (content != null) {
                    ...
                    String last_time = (month + 1) + "月" + day + "日";
                    ...
                    db.execSQL("insert into comments(times,comments,usernames) values('" + last_time + "','" + content + "','" + img_urls + "')");
    ...
    private void initView() {
        ...
        img_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Activity_Main.this, Activity_comment.class);
